...
public:
    ...
    ConstOverloads& Method() const;
            ...
            Assert.True(constOverloadsClass.Members.All(m => m is TranslatedFunction));
            {
                ...
                Assert.False(method1.Metadata.Has<HideDeclarationFromIntellisense>());
            }
            {
                ...
                Assert.True(method2.Metadata.Has<HideDeclarationFromIntellisense>());
            }
        }
...
public:
    ...
    ConstOverloads& Method(int x) const;
            ...
            }
            {
                ...
                Assert.True(method2.IsConst);
                Assert.False(method2.Metadata.Has<HideDeclarationFromIntellisense>());
            }
        }
